...
negx = torch.from_numpy(np.load(os.path.join(TENSOR_DIR, NEG_DATA)))
...
for epoch in range(start_epoch, start_epoch+args.epoch):
    ...
    writer.add_scalars('CNN 4k vs'+args.negdataset+" batch-size "+str(BATCH_SIZE), {'train_loss': train_loss, 
                                            'train_accu':train_accu,
                                            'test_loss': test_loss,
                                            'test_accu':test_accu}, epoch)
"""
python main.py --device "2" --lr 0.0001 --batch-size 64 --negdataset 1080p
python main.py --device "2" --lr 0.0001 --batch-size 16 --negdataset 1080p
python main.py --device "2" --lr 0.0001 --batch-size 64 --negdataset 720p
"""
